...
For reference, this table gives some of the metadata associated with the samples
used in this sequencing run:
...
The final set of markers consists of `r nrow(selected_windows)` selected genome
windows, plus `r nrow(other_targets)` other targets of interest. These
