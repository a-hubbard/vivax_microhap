...
Chelex/saponin method [@bereczkyShortReportRapid2005]. For DBS samples, two 
different extraction methods were tested: the Qiagen QIAamp DNA Investigator 
Kit (referred to as the “kit”) and the Chelex/saponin method
[@bereczkyShortReportRapid2005]. For the Chelex/saponin method, DNA extraction 
...
provided in Supplemental Text 3 and 4.
