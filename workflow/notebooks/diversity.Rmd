---
title: Locus and Sample Diversity
...
Nucleotide diversity was computed for each locus with `pegas::nuc.div()`. Since
...
means that there tend to be a few low frequency haplotypes for each locus that 
...
considerable variability in the diversity of these loci, and a number don't
...
From this figure, it is apparent that there are plenty of loci in the dataset
to distinguish different samples, even once loci with only one allele were
removed. In fact, it appears that only about 15 loci would be sufficient for
this purpose.

# Sample Diversity

To complement locus diversity, sample-level diversity was also estimated with
