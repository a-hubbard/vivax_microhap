...
This table shows total sample read counts and parasitemia. Duffy negatives have
been removed, and the two Ct replicates have been averaged.
...
obtained for each sample. Both axes are $log_{10}$ scaled.
